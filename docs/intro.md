...
Welcome — these are my (and Claude's) notes on philosophy.
...
- [Marcus Aurelius](/docs/stoicism/marcus-aurelius) — Roman Emperor, 121–180 AD
- [Epictetus](/docs/stoicism/epictetus) — Greek Stoic, c. 50–135 AD
- [Seneca](/docs/stoicism/seneca) — Roman statesman, c. 4 BC–65 AD
...
Founded traditionally in 6th century BC China, attributed to Laozi (historicity debated). Developed alongside and in tension with Confucianism. Key figures: Laozi, Zhuangzi. Core ideas: the *Dao* (the ineffable, underlying way of the universe), *wu wei* (effortless, non-forcing action), the balance of yin and yang, and simplicity over social convention. Both a philosophical tradition and, later, an organized religion; remains one of China's major native traditions alongside Buddhism and Confucianism.

- [Laozi](/docs/daoism/laozi) — semi-legendary, traditionally c. 6th century BC
...
Texts worth considering for future full treatment, similar in depth to the Stoic material — favoring public domain sources so the full text can be included:

- **The Dhammapada** — classic verse sayings attributed to the Buddha; closest in form to the Enchiridion. Public domain translations include Max Müller (1881) and the early Pali Text Society editions.
- **The Platform Sūtra of the Sixth Patriarch (Huìnéng)** — foundational Zen text. Wong Mou-Lam's 1930 translation is public domain.
- **The Gateless Gate (Wúménguān / Mumonkan)** — 48 Zen koans with commentary; naturally splits into short chapters the way *Discourses* does. Note: check edition — the popular modern translations (Reps, Aitken, Sekida) are still under copyright; only older translations are public domain.
